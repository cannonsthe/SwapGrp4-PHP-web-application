...
<body>
    ...
    <strong><p style="font-size:40px;text-align:center;">Delete Employee Information</p><strong>
    ...
    <div class="container">
        <form action="Employee_delete2.php" method="post">
            ...
            <input type="submit" class="submit_add" value="DELETE">
        </form>
    </div>
